...
export const PRODUCT_CATALOG: ProductDoseConfig[] = [
  {
    ...
    doses: {
      critical: {
        dose: '每日10粒，分早中晚（早4粒+中3粒+晚3粒），餐后温水送服',
        dose_per_serving: '早4粒+中3粒+晚3粒（≥3000mg EPA）',
        frequency: '每日3次',
        duration: '12周，复查脂肪谱后评估调整',
        evidence_ids: ['E01', 'E09', 'E10'],
      },
      moderate: {
        dose: '每日10粒，分早晚各5粒，餐后温水送服',
        dose_per_serving: '每次5粒（≥1500mg EPA）',
        frequency: '每日2次',
        duration: '12周，复查脂肪谱后评估调整',
        evidence_ids: ['E01', 'E02', 'E10'],
      },
      mild: {
